...
function start() {
    user = prompt("CHOOSE X or O");   /*חלוניצ קטנה מוקפצת לשם התחלת המשחק ובחירת סוג */
...
function gameOver() {
    if ((a.value == b.value && b.value == c.value && a.value == user) ||
        ...
        alert("YOU WIN!!!");/*הקפצת ההתראה בעת ניצחון*/
    }
